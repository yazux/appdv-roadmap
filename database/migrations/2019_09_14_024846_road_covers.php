...
class RoadCovers extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasTable('road_covers')) Schema::create('road_covers', function(Blueprint $table) {
            ...
            $table->unsignedInteger('pavement_layer_type_id')->nullable()->index('road_covers_layer_id_foreign');

            $table->foreign('road_id', 'road_covers_road_id_foreign')->references('id')->on('roads')->onUpdate('NO ACTION')->onDelete('SET NULL');
            $table->foreign('pavement_layer_type_id', 'road_covers_layer_id_foreign')->references('pavement_layer_type_id')->on('covers_types')->onUpdate('NO ACTION')->onDelete('SET NULL');
        });
    }
    ...
    public function down()
    {
        if (Schema::hasTable('road_covers')) {
            Schema::table('road_covers', function (Blueprint $table) {
                ...
                $table->dropForeign('road_covers_layer_id_foreign');
            });
